                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="rn-page-title text-center pt--100">
                                    <h2 className="title theme-gradient2">Gema</h2>
                                    <p>Radar Control</p>
                                        ...
                                        <div className="row row--35 sercice-details-content align-items-center">
                                            <div className="col-lg-6 col-12">
                                                <div className="thumb position-relative">
                                                    ...
                                                    <ModalVideo channel='custom' isOpen={this.state.isOpen} url='./assets/video/radarcontrol.mp4' onClose={() => this.setState({isOpen: false})} />
                                            ...
                                            <div className="col-lg-6 col-12">
                                                <div className="details mt_md--30 mt_sm--30">
                                                    <div className="section-title">
                                                        <span className="subtitle">Radar Control</span>
                                                        <h2 className="title">Gema</h2>
